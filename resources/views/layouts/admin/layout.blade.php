    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                Route::is('admin.about.index') || Route::is('admin.terms-conditions.index') || Route::is('admin.custom-page.*') || Route::is('admin.faq.*') || Route::is('admin.privacy-policy')
                 ? 'show':'' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ Route::is('admin.terms-conditions.index')?'active':'' }}" href="{{ route('admin.terms-conditions.index') }}">{{ $websiteLang->where('lang_key','terms_cond')->first()->custom_text }}</a>
            ...
            <li class="nav-item">
                ...
                <div id="home-section-2-pages" class="collapse {{ Route::is('admin.slider.index') || Route::is('admin.partner.index') || Route::is('admin.testimonial.index') || Route::is('admin.overview.index') || Route::is('admin.service.index') ? 'show': '' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ Route::is('admin.slider.index')?'active':'' }}" href="{{ route('admin.slider.index') }}">{{ $websiteLang->where('lang_key','slider')->first()->custom_text }}</a>
