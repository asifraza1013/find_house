                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="true">{{ $websiteLang->where('lang_key', 'any')->first()->custom_text }}</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                            aria-selected="false">{{ $websiteLang->where('lang_key', 'sell')->first()->custom_text }}</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                            aria-selected="false">{{ $websiteLang->where('lang_key', 'rent')->first()->custom_text }}</button>
                    </li>
                </ul>
                        ...
                        <form method="GET" action="{{ route('search-property') }}">
                            <div class="wsus__serach_single">
                                <select class="select_2" name="city_id">
                                    <option value="">
                                        {{ $websiteLang->where('lang_key', 'select_location')->first()->custom_text }}
                                    </option>
                            ...
                            <div class="wsus__serach_single">
                                <select class="select_2" name="property_type">
                                    <option value="">
                                        {{ $websiteLang->where('lang_key', 'property_type_s')->first()->custom_text }}
                                    </option>
                                    @foreach ($propertyTypes as $property_type_item)
                                        <option value="{{ $property_type_item->id }}">{{ $property_type_item->type }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="wsus__serach_single">
                                ...
                                <button class="common_btn"
                                    type="submit">{{ $websiteLang->where('lang_key', 'search_property')->first()->custom_text }}</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="wsus__about_counter">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="about_small"> {!! clean($aboutUs->about) !!} <a
                                            href="{{ route('about.us') }}">{{ $websiteLang->where('lang_key', 'read_more')->first()->custom_text }}</a>
                                    </div>
                                </div>
    ...
    <div class="row">
        <div class="col-9">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div class="wsus__single_property">
                                            <div class="wsus__single_property_img">
                                                <img src="{{ asset($top_item->thumbnail_image) }}" alt="properties"
                                                    class="img-fluid w-100">

                                                @if ($top_item->property_purpose_id == 1)
                                                    <span
                                                        class="sale">{{ $top_item->propertyPurpose->custom_purpose }}</span>
                                                ...
                                                @if ($top_item->urgent_property == 1)
                                                    <span
                                                        class="rent">{{ $websiteLang->where('lang_key', 'urgent')->first()->custom_text }}</span>
                                                @endif
                                            ...
                                            <div class="wsus__single_property_text">
                                                @if ($top_item->property_purpose_id == 1)
                                                    <span
                                                        class="tk">{{ $currency->currency_icon }}{{ $top_item->price }}</span>
                                                @elseif ($top_item->property_purpose_id == 2)
                                                    <span
                                                        class="tk">{{ $currency->currency_icon }}{{ $top_item->price }}
                                                        /
                                                ...
                                                <a href="{{ route('property.details', $top_item->slug) }}"
                                                    class="title w-100">{{ $top_item->title }}</a>
                                                <ul class="d-flex flex-wrap justify-content-between">
                                                    <li><i class="fal fa-bed"></i> {{ $top_item->number_of_bedroom }}
                                                        {{ $websiteLang->where('lang_key', 'bed')->first()->custom_text }}
                                                    </li>
                                                    <li><i class="fal fa-shower"></i> {{ $top_item->number_of_bathroom }}
                                                        {{ $websiteLang->where('lang_key', 'bath')->first()->custom_text }}
                                                    </li>
                                                    <li><i class="fal fa-draw-square"></i> {{ $top_item->area }}
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ route('search-property', ['page_type' => 'list_view', 'property_type' => $top_item->propertyType->id]) }}"
                                                        class="category">{{ $top_item->propertyType->type }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if ($featured_item->expired_date == null)
                                    <div class="col-xl-4 col-md-6">
                                        <div class="wsus__popular_properties_single">
                                            <img src="{{ asset($featured_item->thumbnail_image) }}"
                                                alt="popular properties">
                                            <a href="{{ route('property.details', $featured_item->slug) }}"
                                                class="wsus__popular_text">
                                                <h4>{{ $featured_item->title }}</h4>
                                                <ul class="d-flex flex-wrap mt-3">
                                                    <li><i class="fal fa-bed"></i> {{ $featured_item->number_of_bedroom }}
                                                        {{ $websiteLang->where('lang_key', 'bed')->first()->custom_text }}
                                                    </li>
                                                    <li><i class="fal fa-shower"></i>
                                                        {{ $featured_item->number_of_bathroom }}
                                                        {{ $websiteLang->where('lang_key', 'bath')->first()->custom_text }}
                                                    </li>
                                                    <li><i class="fal fa-draw-square"></i> {{ $featured_item->area }}
                                                        {{ $websiteLang->where('lang_key', 'sqft_s')->first()->custom_text }}
                                                    </li>
                                                </ul>
                                            </a>
                                            ...
                                            <a href="{{ route('property.details', $featured_item->slug) }}"
                                                ...
                                                <ul class="d-flex flex-wrap mt-3">
                                                    <li><i class="fal fa-bed"></i>
                                                        {{ $featured_item->number_of_bedroom }}
                                                        {{ $websiteLang->where('lang_key', 'bed')->first()->custom_text }}
                                                    </li>
                                                    <li><i class="fal fa-shower"></i>
                                                        {{ $featured_item->number_of_bathroom }}
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="wsus__top_properties_img">
                                                        <img src="{{ asset($urgent_item->thumbnail_image) }}"
                                                            alt="top properties" class="ifg-fluid w-100">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="wsus__top_properties_text">
                                                        <a
                                                            href="{{ route('property.details', $urgent_item->slug) }}">{{ $urgent_item->title }}</a>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-lg-4">
                                        <div class="wsus__top_properties_item">
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="wsus__top_properties_img">
                                                        <img src="{{ asset($urgent_item->images[0]) }}"
                                                            alt="top properties" class="ifg-fluid w-100">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="wsus__top_properties_text">
                                                        <a
                                                            href="{{ route('ads.details', $urgent_item->id) }}">{{ $urgent_item->propertyType->type . '- ' . config('constants.ad_transactions.' . $urgent_item->transactions) }}</a>
                                                        <p><span
                                                                class="tk">{{ config('constants.ad_transactions.' . $urgent_item->transactions) }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                @if ($isOrder > 0)
                                    <div class="col-xl-3 col-sm-6 col-lg-4">
                                        <div class="wsus__single_team">
                                            <a href="{{ route('agent.show', ['user_type' => '2', 'user_name' => $agent->slug]) }}"
                                                class="wsus__single_team_img">
                                                <img src="{{ $agent->image ? url($agent->image) : url($default_profile_image->image) }}"
                                                    alt="team images" class="imf-fluid w-100">
                                            </a>
                                            <a href="{{ route('agent.show', ['user_type' => '2', 'user_name' => $agent->slug]) }}"
                                                class="title">{{ $agent->name }}</a>
                                            <p><i class="fal fa-location-circle"></i> {{ $agent->address }}</p>

                                            <ul class="agent_link">
                                                @if ($agent->icon_one && $agent->link_one)
                                                    <li><a href="{{ $agent->link_one }}"><i
                                                                class="{{ $agent->icon_one }}"></i></a></li>
                                                @endif

                                                @if ($agent->icon_two && $agent->link_two)
                                                    <li><a href="{{ $agent->link_two }}"><i
                                                                class="{{ $agent->icon_two }}"></i></a></li>
                                                @endif

                                                @if ($agent->icon_three && $agent->link_three)
                                                    <li><a href="{{ $agent->link_three }}"><i
                                                                class="{{ $agent->icon_three }}"></i></a></li>
                                                @endif

                                                @if ($agent->icon_four && $agent->link_four)
                                                    <li><a href="{{ $agent->link_four }}"><i
                                                                class="{{ $agent->icon_four }}"></i></a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
            ...
            @if ($blog_section->show_homepage == 1)
                <section class="wsus__blog mt_90 xs_mt_70 pt-4" style="background: #f5f7fb">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="wsus__section_heading text-center mb_60">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="wsus__single_blog">
                                        <div class="wsus__blog_img">
                                            <img src="{{ asset($blog_item->image) }}" alt="blog items"
                                                class="img-fluid w-100">
                                            <span
                                                class="category {{ $color }}">{{ $blog_item->category->name }}</span>
                                        </div>
                                        <div class="wsus__blog_text">
                                            ...
                                            <span class="comment"><i class="fal fa-comment-dots"></i>
                                                {{ $blog_item->comments->count() }}</span>
                                            <div
                                                class="wsus__blog_header d-flex flex-wrap align-items-center justify-content-between">
                                                <div class="blog_header_images d-flex flex-wrap align-items-center w-100">
                                                    <img src="{{ $blog_item->admin->image ? url($blog_item->admin->image) : url($default_profile_image->image) }}"
                                                        alt="bloger" class="img-fluid img-thumbnail">
                                                    <span>{{ $blog_item->admin->name }}</span>
                                                </div>
                                            </div>
                                            <a href="{{ route('blog.details', $blog_item->slug) }}"
                                                class="blog_title">{{ $blog_item->title }}</a>
            ...
            @if ($testimonial_section->show_homepage == 1)
                <section class="wsus__testimonial mt_75 xs_mt_50 pt_90 xs_pt_65 pb_85 xs_pb_100"
                    style="background: url({{ asset('user/images/bg_shape.jpg') }});">
                    <div class="container">
                        <div class="row justify-content-between align-content-center">
                            <div class="col-xl-4 col-lg-4">
                                <div
                                    class="wsus__section_heading d-flex align-content-center justify-content-center flex-column">
                                            ...
                                            <div class="wsus__testi_item">
                                                <div class="row">
                                                    <div class="col-xl-5 col-md-5">
                                                        <div
                                                            class="wsus__testi_img d-flex justify-content-center align-items-center">
                                                            <i class="fal fa-flower top_icon"></i>
                                                            <img src="{{ asset($testimonial_item->image) }}"
                                                                alt="Clients" class="img-fluid img-thumbnail">
                                                    ...
                                                    <div class="col-xl-7 col-md-7">
                                                        <div class="wsus__testi_text">
                                                            ...
                                                            <p><i class="fal fa-quote-right"></i>
                                                                {{ $testimonial_item->description }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="col-lg-3 div col-md-3 col-12 wsus__new_properties pt_90 xs_pt_65 pb_75 xs_pb_50 mt_100 xs_mt_75" style="backgroud: #f5f7fb">
            <div class="p-3">
                <div class="wsus__section_heading mb_40 mt_30">
                    <h2>Advirtisments</h2>
                </div>
                ...
                <div class="ads">
                    <div class="wsus__single_property">
                        <div class="wsus__single_property_img">
                            <img src="{{ asset($top_item->images[0]) }}" alt="properties"
                                class="img-fluid w-100">

                            <span class="sale">{{ config('constants.ad_transactions.'.$top_item->transactions) }}</span>
                        </div>
                        <div class="wsus__single_property_text">
                            <span class="tk">{{ config('constants.feature_country_home.'.$top_item->property_type) }}</span>

                            <a href="{{ route('ads.details', $top_item->id) }}"
                                class="title w-100">{{ $top_item->propertyType->type.'- '. config('constants.ad_transactions.'.$top_item->transactions) }}</a>
                            <ul class="d-flex flex-wrap justify-content-between">
                                <li><i class="fal fa-bed"></i> {{ $top_item->total_bedroom }}
                                    {{ $websiteLang->where('lang_key', 'bed')->first()->custom_text }}
                                </li>
                                <li><i class="fal fa-shower"></i> {{ $top_item->total_bathroom }}
                                    {{ $websiteLang->where('lang_key', 'bath')->first()->custom_text }}
                                </li>
                                <li><i class="fal fa-draw-square"></i> {{ $top_item->built_area }}
                                    {{ $websiteLang->where('lang_key', 'sqft_s')->first()->custom_text }}
                                </li>
                            </ul>
                            <div
                                class="wsus__single_property_footer d-flex justify-content-between align-items-center">
                                <a href="{{ route('ads-listing', ['page_type' => 'list_view', 'property_type' => $top_item->propertyType->id]) }}"
                                    class="category">{{ $top_item->propertyType->type }}</a>
                            </div>
                        </div>
                    </div>
