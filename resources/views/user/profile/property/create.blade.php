    ...
    <div class="col-xl-9 ms-auto">
        <div class="wsus__dashboard_main_content">
              ...
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6">
                  <div class="wsus__property_input">
                    <label>{{ $websiteLang->where('lang_key','title')->first()->custom_text }} <span class="text-danger">*</span></label>
          ...
          <div class="wsus__dash_info pro_det_map p_25 mt_25 pb_0">
            ...
            <div class="wsus__property_inpuT">
              <label>{{ $websiteLang->where('lang_key','des')->first()->custom_text }} <span class="text-danger">*</span>
